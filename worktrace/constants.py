...
# Shipping capability gate. The dormant clipboard implementation is retained so
# it can be developed further without exposing sensitive capture in this release.
