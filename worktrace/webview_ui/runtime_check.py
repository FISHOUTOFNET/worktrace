...
Phase 0C. Detects whether the Microsoft Edge WebView2 Runtime is likely
...
never blocks the Tkinter default UI.
"""
...
_MISSING_HINT = (
    "此功能需要 Microsoft Edge WebView2 Runtime。"
    "请安装 WebView2 Runtime，或继续使用默认 Tkinter UI。"
)
...
def is_webview2_available() -> bool:
    ...
    do not block opt-in WebView startup; the actual failure (if any) is
    surfaced by pywebview when the window is created.
    """
