// WorkTrace WebView frontend - Project Rules module (Phase 5B-5G).
// Core load/render, rule toggle/delete/edit, keyword/folder create.
// Phase 5G project lifecycle actions live in rules_project_actions.js.
...
(function () {
    ...
    // --- Phase 5G: Project lifecycle actions moved to rules_project_actions.js ---
    // (Phase M3 split: project create / edit / toggle / archive handlers now live
    //  in rules_project_actions.js, loaded after this file. They attach to
    //  window.WorkTraceApp via the same IIFE pattern; no behavior change.)
